...
class CriticNetwork(object):
    ...
    def __init__(self, sess, state_dim, action_dim, learning_rate, tau, num_actor_vars):
        ...
        #self.inputs = tf.Print(self.inputs, [tf.shape(self.inputs),
        #                                     tf.shape(self.action),
        #                                     tf.shape(self.out)], "outputs of create_critic_network")
        ...
        #self.out = tf.Print(self.out, [self.out], "self.out value")
        #self.action = tf.Print(self.action, [self.action], "self.out value")
